...
description: "Endpoints for pushing events into Orca AI and verifying your webhook setup"
---
...
Pushes a real-time event into Orca AI's conversation pipeline for a specific user's installation.
...
<ParamField body="event_data" type="object" required>
  Payload with all relevant context. Orca AI uses this to compose the message to the user. Be specific.
</ParamField>
