...
description: "How Orceum handles error responses, retries, and re-authentication from your app"
---
...
If the Orca AI sends parameters your app rejects, return `400` with a descriptive message:
