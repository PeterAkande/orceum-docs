...
description: "Receive signed notifications when users install or uninstall your app"
---
...
Configure your listener URL in `config.installation_webhook_url` during registration or via PATCH:
