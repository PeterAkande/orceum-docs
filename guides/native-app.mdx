...
This guide walks you through building a complete native app on Orceum from scratch. We'll build a **Todo Manager** that lets users create and list tasks via Orca AI.
...
# Now test via an action call (or through Orca AI)
```
