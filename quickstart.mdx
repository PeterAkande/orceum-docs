...
For API key apps, the install flow prompts the user to enter their API key. Orceum encrypts it and automatically injects it into every call using the custom header you defined during app creation (or `X-API-Key` by default).
